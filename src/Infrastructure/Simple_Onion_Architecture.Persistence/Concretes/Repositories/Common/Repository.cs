...
namespace Simple_Onion_Architecture.Persistence.Concretes.Repositories.Common;
    ...
    where TEntity : class, IEntity, new() where TContext : DbContext
{
    ...
    public async Task<IQueryable<TEntity>> GetListAsync(Expression<Func<TEntity, bool>>? predicate = null,
